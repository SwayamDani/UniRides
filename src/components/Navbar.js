...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      <Link to="/" className="navbar__logo">UniRides</Link>
      <div className="navbar__links">
        <Link to="/join-group" className="navbar__link">Join a Group</Link>
        <Link to="/create-group" className="navbar__link">Create Group</Link>
